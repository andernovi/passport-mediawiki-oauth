...
function Strategy(options, verify) {
    ...
    options.requestTokenURL        = options.baseURL + options.requestTokenURL ||  'w/index.php';
    options.accessTokenURL         = options.baseURL + options.accessTokenURL || 'w/index.php?title=Special:OAuth/token';
    options.userAuthorizationURL   = options.baseURL + options.userAuthorizationURL || 'wiki/Special:OAuth/authorize';
    
    OAuthStrategy.call(this, options, verify);
    this.userIdentifyURL = options.baseURL + options.userIdentifyURL || 'w/index.php?title=Special:OAuth/identify';
    this.name = 'mediawiki';
